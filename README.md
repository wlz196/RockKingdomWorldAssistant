# ⚠️ 严重安全警告与行为谴责 (SECURITY WARNING & CONDEMNATION)

**致某位不请自来的“使用者”：**

本项目中因疏忽残留的测试 API Key 已被立即**注销并废弃**。

对于这种监控代码仓库、窃取他人资源、甚至在他人并未授权的情况下恶意刷取额度的行为，我表示强烈的愤怒与鄙视。开源是为了分享技术，而不是为了给贪婪和卑劣提供温床。
